    ...
    <>
      ...
      <main className="min-h-[60vh] py-16 px-6 bg-cream-50">
        <div className="max-w-md mx-auto">
          <h1 className="font-fraunces text-3xl font-bold text-stone-800 mb-4 text-center">
            My Registrations
          </h1>
          ...
          <p className="text-sm text-stone-500 mt-6 text-center">
            ...
            <a href="mailto:connect@creativekidsmusic.org" className="text-forest-600 hover:underline">
