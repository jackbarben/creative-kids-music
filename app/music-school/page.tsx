              ...
              <div className="md:col-span-5">
                <div className="md:sticky md:top-32">
                  ...
                  <p className="text-slate-500 mb-10">
                    We need approximately 8 committed families to make this program work for the 2026–2027 school year. Before we finalize the details, we want to hear from you.
                  </p>
                  <InterestForm />
                </div>
              </div>
