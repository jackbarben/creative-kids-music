...
import { createAccountAndLinkRegistrations } from '@/app/account/actions'
            ...
            <div className="bg-green-50 border border-green-200 rounded-xl p-6 text-center">
              ...
              {totalLinked > 0 ? (
                <p className="text-green-700 mb-4">
                  {t('linkedRegistrations', { count: totalLinked })}
                </p>
              ) : (
                <p className="text-green-700 mb-4">
                  {t('accountReady')}
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <div>
                ...
                {confirmPassword && password !== confirmPassword && (
                  <p className="mt-1 text-sm text-red-600">{t('passwordsDontMatch')}</p>
                )}
              </div>
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-stone-400">{t('or')}</span>
                <div className="flex-1 border-t border-stone-200"></div>
              </div>
