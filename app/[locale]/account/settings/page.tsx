...
import { saveAccountSettings, type AccountSettings } from '@/app/account/actions'
...
export default function SettingsPage() {
  ...
  const handleChangeEmail = async (e: React.FormEvent) => {
    ...
    if (error) {
      ...
      setNewEmail('')
      setEmailPassword('')
      setSuccessMessage(t('checkNewEmailVerification'))
      ...
      <main className="pt-24 pb-16">
        <div className="max-w-2xl mx-auto px-6">
          ...
          <div className="bg-white rounded-2xl border border-slate-100 p-6 mb-6">
            ...
            <div className="mb-6 pb-6 border-b border-slate-100">
              <p className="text-slate-600 mb-4">
                {t('emailLabel')} <span className="font-medium text-slate-800">{user?.email}</span>
              </p>
                ...
                <form onSubmit={handleChangeEmail}>
                  <div className="space-y-3 mb-4">
                    ...
                    <div>
                      ...
                      />
                      <p className="text-xs text-slate-500 mt-1">{t('requiredToChangeEmail')}</p>
                    </div>
                  </div>
                  <LoadingButton
                    type="submit"
            ...
            {isGoogleUser && (
              <div className="mt-6 pt-6 border-t border-slate-100">
                <p className="text-sm font-medium text-slate-700 mb-3">{t('connectedAccounts')}</p>
                <div className="flex items-center gap-3 p-3 bg-slate-50 rounded-lg">
                  ...
                  <span className="text-slate-700">{t('google')}</span>
                  <span className="ml-auto text-sm text-green-600">{t('connected')}</span>
                </div>
              </div>
            )}
          </div>
          ...
          <form onSubmit={handleSaveSettings}>
                ...
                {!showSecondParent ? (
                  ...
                  <div className="pt-4 border-t border-slate-100">
                    <div className="flex items-center justify-between mb-4">
                      <p className="text-sm font-medium text-slate-700">{t('secondParentGuardian')}</p>
                      <button
                        type="button"
                        onClick={() => {
                      ...
                      <div className="grid grid-cols-2 gap-4">
                        <div>
                          ...
                          <input
                            ...
                            className={inputClass}
                            placeholder={t('parent2RelationshipPlaceholder')}
                          />
                        </div>
                        <div>
            ...
            <div className="bg-white rounded-2xl border border-slate-100 p-6 mb-6">
              <h2 className="font-display text-xl font-semibold text-slate-800 mb-4">
                {t('defaultAuthorizedPickups')}
              </h2>
              <p className="text-sm text-slate-500 mb-4">
                {t('defaultPickupsDesc')}
              </p>
                ...
                {(settings.default_pickups || []).map((pickup, index) => (
                  <div key={index} className="p-4 bg-slate-50 rounded-lg">
                    <div className="flex items-center justify-between mb-3">
                      <p className="text-sm font-medium text-slate-700">{t('pickupNumber', { number: index + 1 })}</p>
                      <button
                        type="button"
                    ...
                    <div className="grid grid-cols-3 gap-3">
                      ...
                      <input
                        ...
                        className="px-3 py-2 rounded-lg border border-slate-200 focus:border-forest-500 outline-none text-sm text-slate-800 placeholder:text-slate-400"
                        placeholder={t('relationshipPickupPlaceholder')}
                      />
                    </div>
                  </div>
                ))}
            ...
            <div className="bg-white rounded-2xl border border-slate-100 p-6 mb-6">
              <h2 className="font-display text-xl font-semibold text-slate-800 mb-4">
                {t('standingPermissions')}
              </h2>
              <p className="text-sm text-slate-500 mb-4">
                {t('standingPermissionsDesc')}
              </p>
              ...
              <div className="space-y-4">
                <div className="p-4 border border-slate-200 rounded-lg">
                  <label className="flex items-start gap-3 cursor-pointer">
                    ...
                    />
                    <div>
                      <p className="font-medium text-slate-700">{t('internalDocumentation')}</p>
                      <p className="text-sm text-slate-500 mt-1">
                        {t('internalDocumentationDesc')}
                      </p>
                    </div>
                  </label>
                </div>
                ...
                <div className="p-4 border border-slate-200 rounded-lg">
                  <label className="flex items-start gap-3 cursor-pointer">
                    ...
                    />
                    <div>
                      <p className="font-medium text-slate-700">{t('marketingPublic')}</p>
                      <p className="text-sm text-slate-500 mt-1">
                        {t('marketingPublicDesc')}
                      </p>
                    </div>
                  </label>
                </div>
            ...
            <div className="bg-white rounded-2xl border border-slate-100 p-6 mb-6">
              ...
              <div className="space-y-3">
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  />
                  <div>
                    <p className="font-medium text-slate-700">{t('eventReminders')}</p>
                    <p className="text-sm text-slate-500">{t('eventRemindersDesc')}</p>
                  </div>
                </label>
                ...
                <label className="flex items-center gap-3 cursor-pointer">
                  ...
                  />
                  <div>
                    <p className="font-medium text-slate-700">{t('programAnnouncements')}</p>
                    <p className="text-sm text-slate-500">{t('programAnnouncementsDesc')}</p>
                  </div>
                </label>
              </div>
            </div>
