      ...
      <div className="grid gap-6 lg:grid-cols-3">
        ...
        <div className="lg:col-span-2 space-y-6">
          ...
          {(signup.child_name || signup.child_grade || signup.child_school) && (
            <div className="bg-white rounded-xl border border-stone-200 p-6">
              <h2 className="font-fraunces text-lg font-bold text-stone-800 mb-4">Child Info</h2>
              <dl className="grid gap-4 sm:grid-cols-2">
                {signup.child_name && (
                  <div>
          ...
          {signup.message && (
            <div className="bg-white rounded-xl border border-stone-200 p-6">
              <h2 className="font-fraunces text-lg font-bold text-stone-800 mb-4">Message</h2>
