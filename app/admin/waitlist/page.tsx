...
import { getWaitlistSignupsPaginated } from '@/lib/data'
...
export default async function WaitlistAdmin({ searchParams }: PageProps) {
  ...
  const { data: signups, totalPages, count } = await getWaitlistSignupsPaginated(page, 25, filters)
  ...
  return (
    <div className="space-y-6">
      ...
      <div className="bg-stone-100 rounded-2xl border border-stone-200 p-6">
        <h3 className="font-display text-lg font-bold text-stone-800 mb-4">Program Info</h3>
        <div className="bg-white rounded-xl p-4 border border-stone-200">
          ...
          <p className="text-sm text-stone-500 mt-2">
            {count} total signups on waitlist
          </p>
        </div>
      </div>
      ...
      <div className="bg-white rounded-2xl border border-stone-200 p-6">
        ...
        {signups.length === 0 ? (
          <div className="bg-stone-50 rounded-xl p-8 text-center">
            ...
            <p className="text-stone-500 mb-2">No signups found</p>
